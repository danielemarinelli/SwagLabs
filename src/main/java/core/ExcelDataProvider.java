...
public class ExcelDataProvider {
    ...
    public static List<Map<String, String>> getCredentialsTestData() throws IOException {
        List<Map<String,String>> testDataAllRows=null;
        Map<String,String> testData=null;
        FileInputStream fileInputStream=new FileInputStream("./src/main/resources/testdata/CredentialsFile.xlsx");
